...
if [ -f "/sys/class/backlight/panel0-backlight/brightness" ];then
    if [ x"$1" != "xphone" ] ; then
        ...
        if [[ "_$platform" == "_lahaina" ]] || [[ "_$platform" == "_taro" ]] || [[ "_$platform" == "_kalama" ]] || [[ "_$platform" == "_pineapple" ]] || [[ "_$platform" == "_sun" ]] || [[ "_$platform" == "_canoe" ]]; then
...
if  [[ "_$platform" == "_sun" ]]; then
    if [ -f "/sys/class/leds/aw22xxx_led/effect" ];then
        echo 2 > /sys/class/leds/aw22xxx_led/effect
